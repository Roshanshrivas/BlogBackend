...
const CreateBlog = () => {
    ...
    const createPost = async (e) => {
        ...
        try{
            ...
            const res = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/api/createBlog`, {
                title,
                content,
                author: "Roshan",
                tags,
    ...
    <div className="md:w-[60vw] bg-white my-20 mx-auto p-4 rounded-2xl">
      ...
      <form onSubmit={createPost} className="grid grid-cols-1 gap-3 my-6">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col md:flex-row justify-between gap-2 md:gap-0">
            ...
            <button
              ...
              className="py-2 px-8 text-base bg-purple-500 hover:bg-purple-400
          rounded-3xl text-white font-semibold w-fit"
            >
              Add Tag
            </button>
          </div>
        ...
        <div>
          ...
          <button
            type="submit"
            className="py-2 px-8 text-base bg-purple-500
              hover:bg-purple-400 rounded-3xl text-white font-semibold w-fit mt-2"
          >
            Create Blog
          </button>
        </div>
